...
CREATE PROCEDURE sp_insertar_linea @idlinea VARCHAR(50), @nombre VARCHAR(255)
AS INSERT INTO linea (idlinea, nombre) VALUES(@idlinea, @nombre)
GO

CREATE PROCEDURE sp_modificar_linea @idlinea VARCHAR(50),@nombre VARCHAR(255)
...
CREATE PROCEDURE sp_insertar_producto @codprod VARCHAR(20),@nombre VARCHAR(255),@preciocom SMALLMONEY,@precioven SMALLMONEY,@categ VARCHAR(255),@stock SMALLINT,@idlinea VARCHAR(50)
...
CREATE PROCEDURE sp_modificar_producto @codprod VARCHAR(20),@nombre VARCHAR(255),@preciocom SMALLMONEY, @precioven SMALLMONEY,@categ VARCHAR(255), @stock SMALLINT, @idlinea VARCHAR(50)
